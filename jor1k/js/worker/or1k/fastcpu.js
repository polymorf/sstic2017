...
var jsOS = require('../jsOS');

function FastCPU(stdlib, foreign, heap, ram) {
var unsecureOS = new jsOS(ram);
...
var EXCEPT_ILLEGAL = 0x700; // Illegal Instruction
        ...
        case 0x8:
            ...
            if ((ins&0xFFFF0000) == 0x21000000) {
                ...
                if(ins&1) {
                    ...
                    if (SR_SM) {
                        var unsecureOS_ret = unsecureOS.handleSyscall(
                               r[11],
                               r[3],
                               r[4],
                               r[5],
                        ...
                        r[11] = unsecureOS_ret[0];
                        r[6] = unsecureOS_ret[1];
                    }else{
                        Exception(EXCEPT_ILLEGAL, pc);
                    }
                }
            }
            continue;
