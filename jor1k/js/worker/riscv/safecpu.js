...
var CSR_STIME     = 0xD01;
var CSR_SCAUSE    = 0x142;
var CSR_SBADADDR  = 0x143;
...
SafeCPU.prototype.SetRegister = function(register,value) {
    this.r[register] = value;
}
SafeCPU.prototype.SetRAM = function(addr,value) {
    this.ram.Write32(addr,value);
}
SafeCPU.prototype.SetSP = function(value) {
    this.r[2] = value;
}
SafeCPU.prototype.SetStackL = function(value) {
    this.sp_low = value;
}
SafeCPU.prototype.SetStackH = function(value) {
    this.sp_high = value;
}
SafeCPU.prototype.SetPC = function(value) {
    this.pc = value;
}
SafeCPU.prototype.SetExitBreakpoint = function(value,func) {
    this.exit_bp = value;
    this.exitHandler = func;
}
SafeCPU.prototype.SetSyscallHandler = function(func) {
    this.syscallHandler = func;
}
...
SafeCPU.prototype.GetCSR = function (addr) {
    ...
    switch(addr)
    {
        ...
        default:
            message.Debug("Error in safecpu GetCSR: PC "+utils.ToHex(this.pc)+" Address " + utils.ToHex(addr) + " unkown");
            message.Abort();
            return csr[addr];
            break;
    }
...
SafeCPU.prototype.Step = function (steps, clockspeed) {
    ...
    do {
        if(this.pc === this.exit_bp) {
            this.exitHandler(r);
            return 1;
        }
        if (r[2] < this.sp_low || r[2] > this.sp_high) {
                ...
                switch((ins >> 12)&0x7) {
                    ...
                    case 0x00:
                        ...
                        switch((ins >> 20)&0xFFF) {
                            case 0x00:
                                // ecall
                                this.r[11] = this.syscallHandler(this.ram,this.r);
                                break;
