...
function Disassemble(ins,r,csr,pc) {
    ...
    message.Debug("pc : "+utils.ToHex(pc)+" sp : "+utils.ToHex(r[2]));
    switch(ins&0x7F) {
            ...
            switch((ins >> 12)&0x7) {
                ...
                case 0x00:
                    ...
                    switch((ins >> 20)&0xFFF) {
                        ...
                        case 0x001:
                            //ebreak
                            message.Debug("ebreak - "+ utils.ToHex(ins)+" at PC" + utils.ToHex(pc));
                            break;
        ...
        default:
            message.Debug("Error in safecpu: Instruction " + utils.ToHex(ins) + " not found at "+utils.ToHex(pc));
            break;
    }
